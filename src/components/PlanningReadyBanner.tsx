...
export function PlanningReadyBanner({ onGoOut, onDismiss }: PlanningReadyBannerProps) {
  return (
    <div className="bg-gradient-to-r from-[#a855f7]/20 to-[#d4ff00]/10 backdrop-blur border border-[#a855f7]/30 rounded-xl px-3 py-2.5 flex items-center gap-2 animate-fade-in">
