...
export const NYC_DEMO_USERS = [
  { display_name: 'Alex Rivera', username: 'alex_spotted', avatar_url: null, bio: 'NYC nightlife enthusiast 🌃' },
  { display_name: 'Sam Chen', username: 'samthenight', avatar_url: null, bio: 'Always out, always vibing ✨' },
  { display_name: 'Jordan Lee', username: 'jordanspots', avatar_url: null, bio: 'Finding the best spots in Brooklyn' },
  { display_name: 'Taylor Kim', username: 'taylornights', avatar_url: null, bio: 'Dance floor detective 💃' },
  { display_name: 'Morgan Davis', username: 'morganthemover', avatar_url: null, bio: 'Music lover | Late night explorer' },
  { display_name: 'Casey Park', username: 'caseygoesout', avatar_url: null, bio: 'Living for the weekend 🎉' },
  { display_name: 'Riley Thompson', username: 'rileyrave', avatar_url: null, bio: 'Techno lover 🎧' },
  { display_name: 'Jamie Martinez', username: 'jamieout', avatar_url: null, bio: 'Brooklyn based DJ' },
  { display_name: 'Avery Wilson', username: 'averynight', avatar_url: null, bio: 'House music fanatic 🏠' },
  { display_name: 'Quinn Brown', username: 'quinnvibes', avatar_url: null, bio: 'Living for bass drops' },
  { display_name: 'Drew Anderson', username: 'drewdances', avatar_url: null, bio: 'Dance till sunrise 🌅' },
  { display_name: 'Skylar Garcia', username: 'skylarnights', avatar_url: null, bio: 'NYC club explorer' },
  { display_name: 'Reese Johnson', username: 'reeseout', avatar_url: null, bio: 'Warehouse party hunter 🏭' },
  { display_name: 'Peyton Miller', username: 'peytonspots', avatar_url: null, bio: 'Underground scene devotee' },
  { display_name: 'Emerson Lee', username: 'emersonvibes', avatar_url: null, bio: 'Beats & good times 🎵' },
  { display_name: 'Cameron White', username: 'camnight', avatar_url: null, bio: 'Nightlife curator' },
  { display_name: 'Dakota Scott', username: 'dakotaraves', avatar_url: null, bio: 'Always at the afters 🌙' },
  { display_name: 'Parker Adams', username: 'parkerspotted', avatar_url: null, bio: 'Deep house devotee' },
  { display_name: 'Sage Turner', username: 'sagenights', avatar_url: null, bio: 'Brooklyn nightlife 💜' },
  { display_name: 'River Hayes', username: 'riverout', avatar_url: null, bio: 'Techno till dawn 🌃' },
];

export const LA_DEMO_USERS = [
  { display_name: 'Luna Martinez', username: 'luna_la', avatar_url: null, bio: 'LA nightlife explorer 🌴' },
  { display_name: 'Chase Bennett', username: 'chasenights', avatar_url: null, bio: 'West Coast vibes only 🌊' },
  { display_name: 'Mia Rodriguez', username: 'mia_out', avatar_url: null, bio: 'Hollywood nights 🎬' },
  { display_name: 'Dylan Cooper', username: 'dylanspots', avatar_url: null, bio: 'DTLA regular 🏙️' },
  { display_name: 'Zoe Williams', username: 'zoevibes', avatar_url: null, bio: 'Sunset Strip enthusiast' },
  { display_name: 'Blake Torres', username: 'blakeout', avatar_url: null, bio: 'House music lover 🎵' },
  { display_name: 'Aria Santos', username: 'arianights', avatar_url: null, bio: 'WeHo nightlife 💜' },
  { display_name: 'Mason Clark', username: 'masonraves', avatar_url: null, bio: 'LA club connoisseur' },
  { display_name: 'Ivy Nguyen', username: 'ivy_spots', avatar_url: null, bio: 'Always at Exchange 🔥' },
  { display_name: 'Kai Foster', username: 'kai_nights', avatar_url: null, bio: 'Sound Nightclub regular' },
  { display_name: 'Nova Gray', username: 'novavibes', avatar_url: null, bio: 'LA after hours 🌙' },
  { display_name: 'River Stone', username: 'riverdances', avatar_url: null, bio: 'Deep house devotee' },
  { display_name: 'Sage Mitchell', username: 'sage_la', avatar_url: null, bio: 'Arts District nights 🎨' },
  { display_name: 'Phoenix Reed', username: 'phoenixout', avatar_url: null, bio: 'Hollywood Hills vibes' },
  { display_name: 'Rowan Price', username: 'rowanspots', avatar_url: null, bio: 'LA techno scene 🎧' },
  { display_name: 'Aspen Cruz', username: 'aspenights', avatar_url: null, bio: 'Silverlake regular' },
  { display_name: 'Cody James', username: 'codyraves', avatar_url: null, bio: 'LA warehouse parties 🏭' },
  { display_name: 'Eden Walsh', username: 'eden_vibes', avatar_url: null, bio: 'West Coast beats' },
  { display_name: 'Flynn Hayes', username: 'flynn_la', avatar_url: null, bio: 'LA nightlife curator 🌟' },
  { display_name: 'Harper Lane', username: 'harpernights', avatar_url: null, bio: 'Living for LA nights ✨' },
];

export const PB_DEMO_USERS = [
  { display_name: 'Brooks Wellington', username: 'brooks_pb', avatar_url: null, bio: 'Palm Beach nightlife 🌴' },
  { display_name: 'Sloane Carter', username: 'sloane_worth', avatar_url: null, bio: 'Worth Avenue regular ✨' },
  { display_name: 'Preston Monroe', username: 'prestonpb', avatar_url: null, bio: 'Clematis Street explorer' },
  { display_name: 'Blair Ashford', username: 'blair_nights', avatar_url: null, bio: 'CityPlace enthusiast 🎉' },
  { display_name: 'Trey Worthington', username: 'trey_wpb', avatar_url: null, bio: 'WPB nightlife curator' },
  { display_name: 'Mila Beaumont', username: 'mila_island', avatar_url: null, bio: 'Island life 🏝️' },
  { display_name: 'Chase Devereaux', username: 'chase_pb', avatar_url: null, bio: 'Breakers bar hopper' },
  { display_name: 'Hadley Pierce', username: 'hadley_vibes', avatar_url: null, bio: 'South Florida nights 🌙' },
  { display_name: 'Reid Thornton', username: 'reid_out', avatar_url: null, bio: 'Always at Respectable' },
  { display_name: 'Tinsley Graham', username: 'tinsley_pb', avatar_url: null, bio: 'Palm Beach socialite 💎' },
];
